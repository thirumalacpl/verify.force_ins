...
//alert(oneemp);
  $('.sddqiveri').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.sdd').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.sdd').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
