...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://staging.eimpressive.com/slim_insurance/slim_four_ripsssjs/dash_await.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://staging.eimpressive.com/slim_insurance/slim_four_ripsssjs/dashinprogressa.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
