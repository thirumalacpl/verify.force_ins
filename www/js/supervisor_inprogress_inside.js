...
//alert(oneemp);
  $('.sddqi').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.sddq').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if(qualification_id == '97' ){
  ...
  $('#fir_details').show();
var fir_details_dis='<li class="li_hei">  <p class="li_p_pri"><span class="fonn">Name of Police Station:</span><span class="fonnt">'+fir_detai.name_of_ps+'</span></p></li><li class="li_hei">  <p class="li_p_pri"><span class="fonn">Address of Police Station:</span><span class="fonnt">'+fir_detai.address_of_ps+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Date of FIR:</span><span class="fonnt">'+fir_detai.fir_date+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">FIR No:</span><span class="fonnt">'+fir_detai.fir_no+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Investigating Officers details:</span><span class="fonnt">'+fir_detai.investigate_police_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Any delay in filing the FIR:</span><span class="fonnt">'+fir_detai.delay_in_fir+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Vehicle Details mentioned in the FIR:</span><span class="fonnt">'+fir_detai.vehicle_details+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Details of the Charge sheet:</span><span class="fonnt">'+fir_detai.charge_sheet+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">State:</span><span class="fonnt">'+fir_detai.city_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">City:</span><span class="fonnt">'+fir_detai.city_name+'</span></p></li>'
$('#fir_details_disa').append(fir_details_dis);
}
if(qualification_id == '100' ){
  alert(qualification_id+'100');
  $('#driver_owner').show();
var sderqwe='<li class="li_hei">  <p class="li_p_pri"><span class="fonn">Name :</span><span class="fonnt">'+driver_details_o.name+'</span></p></li><li class="li_hei">  <p class="li_p_pri"><span class="fonn">Address :</span><span class="fonnt">'+driver_details_o.address+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Contact No:</span><span class="fonnt">'+driver_details_o.con_no+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Select Gender :</span><span class="fonnt">'+driver_details_o.gender+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">DOB:</span><span class="fonnt">'+driver_details_o.dob+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Driving Licence No:</span><span class="fonnt">'+driver_details_o.dl_no+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Issuing Authority:</span><span class="fonnt">'+driver_details_o.issue_autho+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Date of issue:</span><span class="fonnt">'+driver_details_o.issue_autho+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Date of Expiry:</span><span class="fonnt">'+driver_details_o.city_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Vehicles authorized to drive:</span><span class="fonnt">'+driver_details_o.vec_auth+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Badge No:</span><span class="fonnt">'+driver_details_o.bdg_no+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Date if Applicable:</span><span class="fonnt">'+driver_details_o.city_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">State:</span><span class="fonnt">'+driver_details_o.city_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">City:</span><span class="fonnt">'+driver_details_o.city_name+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Provide opposite Vehicles driver details:</span><span class="fonnt">'+driver_details_o.opp_dr_dtls+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Driver involved in any accident in last 2 years:</span><span class="fonnt">'+driver_details_o.dr_invloved+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Is the driver involved in any accident in the last two years:</span><span class="fonnt">'+driver_details_o.dr_influ+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Is the driver under any influence of intoxicating liquor or drugs:</span><span class="fonnt">'+driver_details_o.othr_info+'</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Any other relevant information:</span><span class="fonnt">'+driver_details_o.othr_info+'</span></p></li>'
$('#driver_owner_details_list').append(sderqwe);
}
if(qualification_id == '104' ){
  alert(qualification_id+'104');
  $('#insured_person_details').show();
//var sder='<li class="li_hei">  <p class="li_p_pri"><span class="fonn">Name:</span><span class="fonnt">+servant_educa.add_one+</span></p></li><li class="li_hei">  <p class="li_p_pri"><span class="fonn">MACT Number:</span><span class="fonnt">+servant_educa.add_two+</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Insurance Name:</span><span class="fonnt">+servant_educa.pincode+</span></p></li><li class="li_hei">   <p class="li_p_pri"><span class="fonn">Date of Accident and Time:</span><span class="fonnt">+servant_educa.city_name+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Speed of vehicle:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Odometer reading:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Exact Place of Accident including Address/Spot of Accident with LandMark:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Location of the Accident:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Purpose of travel at the time of Accident:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">No. of people travelling at the time of Accident and in what capacity:</span><span class="fonnt">+servant_educa.state+</span></p></li><li class="li_hei"> <p class="li_p_pri"><span class="fonn">Details of third party involved in the accident:</span><span class="fonnt">+servant_educa.state+</span></p></li>'
//$('#sderf').append(sder);
}
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddq').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" onerror="imgError(this);"></a></li>');
...
//$('.document_imag_inprooneqc').append('<img src="http://staging.eimpressive.com/uploads/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+one+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inprooneqd').append('<img src="http://staging.eimpressive.com/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneo+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneemp');
//$('.document_imag_inprooneqc').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
//$('.document_imag_inprooneqd').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');

}
if (j == 2 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqb').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 3 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqa').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 4 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqe').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 5 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqf').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
