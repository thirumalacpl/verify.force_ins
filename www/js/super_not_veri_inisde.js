...
//alert(oneemp);
  $('.sddqinot').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+one+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneo+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneoo+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oneooo+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/uploads/'+oner+'"><img src="http://staging.eimpressive.com/insurance/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.ssd').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if ( j == 0){
  ...
  //alert(one+'oneiiiiiiiiiiiiiiiiiiiiiiiiiii');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
  $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 2){
  var oneoo=oneaddress[j];
//alert(oneoo+'3');
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneoo+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 3){
  var oneooo=oneaddress[j];
//alert(oneooo+'4');
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oneooo+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oner+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
//$('.document_imag_inproone_notverif').append('<img src="http://staging.eimpressive.com/insurance/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance/documents/addressid/'+oner+'"><img src="http://staging.eimpressive.com/insurance/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
